...
class Mineral extends Component{
    render() {
        return <section className='mineral'>
            ...
            <ul className='divisionMineral'><a className='minerals'> Podział</a>
            ...
            <ul className='mineralmakro'>
                <a className='mineralmikro'> Innym podziałem składników mineralnych jest podział według kryterium ilościowego:</a>
